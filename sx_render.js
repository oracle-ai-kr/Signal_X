  ...
  body.innerHTML = `
    ...
    ${(()=>{
      ...
      return `<div class="anal-section">
        ...
        ${fin.eps!=null?`<div class="anal-row"><span class="al">EPS${fin._epsSource==='dart'?' <span style="font-size:8px;color:var(--text3);font-weight:normal">DART 기반</span>':''}</span><span class="ar">${fin.eps.toLocaleString()}원</span></div>`:''}
